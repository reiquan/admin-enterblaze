...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('card_characters', function (Blueprint $table) {
            //
            $table->integer('card_character_mental');
            $table->integer('card_character_physical');
            $table->integer('card_character_spiritual');
    ...
    public function down(): void
    {
        Schema::table('card_characters', function (Blueprint $table) {
            ...
            $table->dropColumn('card_character_abilities')->nullable();
