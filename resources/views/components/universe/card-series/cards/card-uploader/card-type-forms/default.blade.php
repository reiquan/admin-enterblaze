<form method="get" action="{{ route('cards.create', ['universe_id' => $universe_id ?? $universe->id, 'card_series_id' => $card_series_id, 'card_id' => $card->id]) }}" enctype="multipart/form-data">
    @csrf
    ...
    <input type="hidden" name="card_id" value="{{ $card->id }}">
        ...
        <section class="border-t border-gray-200 pt-8">
            ...
            <div class="mt-5">
                <label for="tag-input" class="{{ $labelClass }}"> Effects</label>
                ...
                <input type="hidden" name="card_tags" id="event-tags-hidden" value="{{ old('card_tags', $location->bonuses ?? '') }}">
