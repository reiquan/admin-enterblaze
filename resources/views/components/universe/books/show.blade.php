                        ...
                        <td class="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    ...
                                    <a href="{{ Storage::disk('s3-public')->url($issue->issue_image_cover) }}" target="_blank"> <img src="{{ Storage::disk('s3-public')->url($issue->issue_image_cover) }}" alt="Image" class="aspect-[4/5] w-52 flex-none rounded-2xl object-cover"></a>
