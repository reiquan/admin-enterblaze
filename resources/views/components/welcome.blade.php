    ...
    @if(auth()->check() && auth()->user()->current_team_id == 2)
        <div class="mt-8 border-t border-gray-200 pt-8">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <a href="{{ route('polls.index') }}" class="group rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-red-200 hover:shadow-md">
                    <div class="flex items-center">
                        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-red-50 text-red-800 ring-1 ring-red-100">
                ...
                <a href="{{ route('subscribers.index') }}" class="group rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-red-200 hover:shadow-md">
                    <div class="flex items-center">
                        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-red-50 text-red-800 ring-1 ring-red-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-gray-500">
                        Configure subscriptions for your platform.
                    </p>
