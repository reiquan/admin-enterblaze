                                ...
                                <div class="p-5">
                                    ...
                                    <div class="mt-5 grid grid-cols-2 gap-3 text-sm">
                                        <div class="rounded-2xl bg-gray-50 p-3">
                                            ...
                                            <p class="mt-1 font-black text-gray-900">{{ $card->type->card_type_name ?? $card->card_type ?? 'Not set' }}</p>
                                        </div>
                                        <div class="rounded-2xl bg-gray-50 p-3">
                                            <p class="text-xs font-bold uppercase tracking-widest text-gray-400">Tier</p>
                                            <p class="mt-1 font-black text-gray-900">{{ $card->tier->card_tier_name ?? $card->card_tier_name ?? 'Not set' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
