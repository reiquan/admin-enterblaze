                                            ...
                                            <div class="sm:col-span-4">
                                                ...
                                                <div class="mt-2">
                                                    <input type="text"
                                                           ...
                                                           value="{{ old('card_series_subtitle') }}"
                                                           class="block w-full rounded-xl border-0 bg-white px-4 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
                                            ...
                                            <div class="sm:col-span-3">
                                                ...
                                                <div class="mt-2">
                                                    <input type="date"
                                                           ...
                                                           value="{{ old('card_series_published_at') }}"
                                            ...
                                            <div class="col-span-full">
                                                ...
                                                <div class="mt-2">
                                                    <textarea id="card_series_description"
                                                              ...
                                                              rows="5"
                                                              class="block w-full rounded-xl border-0 bg-white px-4 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
                                                              placeholder="Write a few sentences about this book, manga, or card series.">{{ old('card_series_description') }}</textarea>
                                                </div>
